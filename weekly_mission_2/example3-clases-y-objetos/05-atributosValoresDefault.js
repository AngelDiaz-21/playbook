...
class PullRequest {
    ...
    getInfo2() {
        return `This PR is in the repo: ${this.title} (status: ${this.status}) and was created on ${this.dateCreated}`
    }
}
...
const myPR2 = new PullRequest("Launch", "Mi segundo PR", 99)
console.log(myPR2.getInfo())

// Puedes instanciar n cantidad de objetos de la misma clase
const myPR3 = new PullRequest("Launch X - Innovaccion", "Mi segundo PR", 99)

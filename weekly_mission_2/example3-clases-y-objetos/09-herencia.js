...
const studentLaunchX = new LaunchXStudent("Angel", "js", ["php", "laravel", "Vue"])
console.log(studentLaunchX)
console.log(studentLaunchX.getName) // getter de la clase padre rehusada en la clase hija
